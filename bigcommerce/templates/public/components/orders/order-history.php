...
<?php if ( $wrap ) { ?>
	...
	<div><ul class="bc-order-list bc-load-items-container <?php echo( ! empty( $pagination ) ? esc_attr( 'bc-load-items-container--has-pages' ) : '' ); ?>">As orders are placed, they will be listed below.</div>
<?php } ?>
